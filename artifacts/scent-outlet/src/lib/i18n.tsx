...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    countryLT: 'Lithuania',
    countryEE: 'Estonia',
    carrierMethod: 'Delivery method',
    pickupPointLabel: 'Parcel locker / pickup point',
    choosePickupPoint: 'Choose a parcel locker...',
    searchPickupPlaceholder: 'Search by name, address or city...',
    noPointsFound: 'No locations found',
    loadingPoints: 'Loading locations...',
    ...
    agreePrefix: 'By placing your order you agree to our ',
  ...
  lv: {
    ...
    countryLT: 'Lietuva',
    countryEE: 'Igaunija',
    carrierMethod: 'Piegādes veids',
    pickupPointLabel: 'Pakomāts / saņemšanas vieta',
    choosePickupPoint: 'Izvēlieties pakomātu...',
    searchPickupPlaceholder: 'Meklēt pēc nosaukuma, adreses vai pilsētas...',
    noPointsFound: 'Nekas netika atrasts',
    loadingPoints: 'Ielādē saņemšanas vietas...',
    ...
    agreePrefix: 'Veicot pasūtījumu, jūs piekrītat mūsu ',
    agreeTermsLink: 'Lietošanas noteikumiem',
    agreeAnd: ' un ',
    agreePrivacyLink: 'Privātuma politikai',
    agreeSuffix: '.',
