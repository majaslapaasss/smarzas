...
export default function Checkout() {
  ...
  const onSubmit = (data: CheckoutFormValues) => {
    if (!cart || cart.items.length === 0) {
      toast({
        ...
        description: "Please add some items to your bag before checking out.",
        variant: "destructive"
      });
      return;
    }
  ...
  if (!cart || cart.items.length === 0) {
    return (
      <div className="container mx-auto px-4 py-24 text-center max-w-lg">
        ...
        <p className="text-muted-foreground mb-8">Cannot proceed to checkout with an empty bag.</p>
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 max-w-6xl">
      <div className="mb-12">
        <h1 className="font-serif text-3xl md:text-4xl font-medium mb-2">Checkout</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                <div className="space-y-6">
                  <h2 className="font-serif text-2xl font-medium">Contact Information</h2>
                ...
                <div className="pt-6 border-t border-border space-y-6">
                  <h2 className="font-serif text-2xl font-medium">Shipping Details</h2>
        ...
        <div className="lg:col-span-5">
          <div className="bg-secondary/20 p-6 md:p-8 rounded-3xl sticky top-24">
            <h2 className="font-serif text-2xl font-medium mb-6">In Your Bag</h2>
            ...
            <div className="border-t border-border pt-6 space-y-4 text-sm">
              ...
              {shippingCents > 0 && (
                <p className="text-xs text-muted-foreground mt-1">
                  Spend {formatPrice(5000 - cart.subtotalCents)} more for free shipping.
                </p>
              )}
            </div>
